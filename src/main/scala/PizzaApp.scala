...
object PizzaApp {
  ...
  //Доброго!
  // Подскажите, пожалуйста, степень необходимости создавать отдельный case class для каждой промежуточной трансформации?
  // или нормально использовать в качестве выходного, например, Dataset[(String,Int)]
  ...
  def main(args: Array[String]): Unit = {
    ...
    if (args.length != 2) {
      println("Specify the paths to the File")
      System.exit(1)
    }
    ...
    statOrders.show(10, truncate = false)
